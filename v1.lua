...
local Actyrn_7104 = UiLib:CreateWindow("Polar | Private | v1 | badovh | cz", Vector2.new(500, 600), Enum.KeyCode.RightShift)
...
local function handleTeleporting()
    isCheckingArmor = false -- Disable checking armor until it increases above 10
